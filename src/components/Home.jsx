...
function Home() {
  ...
  <div className="container-fluid">
    <a className="navbar-brand" style={{ color: "#FFA500" }}>
      Suriya's Portfolio
    </a>
    ...
    <div className="collapse navbar-collapse justify-content-between" id="navbarNav">
      ...
      <div className="d-flex align-items-center social-nav-icons">
      ...
      <div className="container-fluid hero-section">
        <div className="hero-image-wrapper">
          ...
          <h1 className="hero-text-overlay">
            ...
            <div>
            <a href="https://drive.google.com/file/d/1qRimaJ4ZAOj4p_U_o2u64owfCuZ0T-sO/view?usp=drivesdk"
